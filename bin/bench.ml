    ...
    [
      create_group ~name:"small"
        [
          ...
          create ~name:"std" (fun () -> combinations ~k:6 ~n:10 ignore);
        ];
      create_group ~name:"med"
        [
           ...
           *       |> iter ~f:(fun _ -> Sys.opaque_identity ()))); *)
          create ~name:"std" (fun () -> combinations ~k:5 ~n:25 ignore);
        ];
      create_group ~name:"large"
        [ create ~name:"std" (fun () -> combinations ~k:11 ~n:33 ignore) ];
    ]
    ...
    [
      create_group ~name:"med"
        [
          ...
          create ~name:"std" (fun () -> permutations ~n:8 ignore);
        ];
    ]
